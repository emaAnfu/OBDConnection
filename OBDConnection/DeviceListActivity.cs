...
namespace OBDConnection
{
    ...
    class DeviceListActivity : Activity
    {
        ...
        //public const string EXTRA_DISCOVERABLE = "discoverable";
        ...
        protected override void OnStop()
        {
            ...
            //// Create the result Intent and tell activity1 to change state
        ...
        {
            Activity _connection;

            public Receiver(Activity connection)
            {
            ...
            public override void OnReceive(Context context, Intent intent)
            {
                ...
                else if (action == BluetoothAdapter.ActionDiscoveryFinished)
                {
                    ...
                    {
                        //var noDevices = _connection.Resources.GetText(Resource.String.none_found).ToString();
                        var noDevices = _connection.Resources.GetText(Resource.String.none_found).ToString();
        ...
        private void EnsureDiscoverable()
        {
            ...
            Intent intent = new Intent();
            intent.PutExtra(EXTRA_DEVICE_ADDRESS, discoverable);
